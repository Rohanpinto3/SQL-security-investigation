...
I worked with two datasets — **employees** and **log_in_attempts** — to investigate possible security incidents inside a large organization.
...
[sql-security-investigation.pdf](./sql-security-investigation.pdf.pdf) - View Full PDF Report
